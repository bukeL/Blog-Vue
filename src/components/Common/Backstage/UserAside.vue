  ...
  <div class="aside">
    ...
    <ul class="nav">
      <li :class="show==1?active:''"  @click ="ybShow">
        <router-link :to = "{name:'UserHome'}"><i class="fa fa-dashboard"></i>仪表盘</router-link>
      </li>
      <li :class="(show==2||show==3||show==4)?active:''">
        ...
        <ul  v-show ="isShow">
          <li @click ="allpShow" :class="show==2?active:''"><router-link :to = "{name:'UserAllPosts'}">所有文章</router-link></li>
